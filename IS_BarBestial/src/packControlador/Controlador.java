...
public class Controlador {
	...
	class RegistrarseListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			JOptionPane.showMessageDialog(null, user + ", te has registrado con �xito");
		}
	}
	...
	class RecuperarContrasenaListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			JOptionPane.showMessageDialog(null, user + ", tu nueva contrase�a es " + nuevaPass);
		}
	}
	...
	//listener de ventanacambiarcontrase�a
