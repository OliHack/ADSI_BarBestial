...
public class Ranking extends JFrame {
	...
	private RankingDB rankingDB = RankingDB.getRankingDB();
	...
	public Ranking() {
		...
		btnPersonalAbsoluto.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				VentanaMejIndv.getMejIndv().actualizarRanking(rankingDB.getMejInd());
		...
		btnPersonalPorNiveles.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				miRanking.setVisible(false);
				VentanaHoy.getHoy().actualizarRanking(rankingDB.getMejHoy());
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				miRanking.setVisible(false);
				VentanaSiempre.getSiempre().actualizarRanking(rankingDB.getMejSiempre());
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				miRanking.setVisible(false);
				VentanaMedias.getMedias().actualizarRanking(rankingDB.getMejMedias());
