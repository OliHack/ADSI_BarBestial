...
public class VentanaMedias extends JFrame {
	...
	private static VentanaMedias miMedias;
    ...
    public VentanaMedias() {
    	setTitle("TOP 10 MEJORES MEDIAS");
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                VentanaMedias frame = new VentanaMedias();//cambiar
    ...
    public static VentanaMedias getMedias() {
		if (miMedias == null) {
			miMedias = new VentanaMedias();
		}
		return miMedias;
	}
}